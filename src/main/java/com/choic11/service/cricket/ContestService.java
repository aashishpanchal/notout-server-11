...
import com.choic11.model.cricket.TblCricketContestMatch;
...
import com.choic11.repository.cricket.ContestRepository;
...
public class ContestService {
    ...
    public BaseResponse getMatchContest(BaseRequest baseRequest, int matchId, int matchUniqueId) {
        ...
        TblCricketMatch matchMiniDataOnly = matchesService.getMatchesRepository().getMatchMiniDataOnly(matchUniqueId);
    ...
    public BaseResponse getCustomerMatchContest(BaseRequest baseRequest, int matchId, int matchUniqueId) {
        ...
        TblCricketMatch matchData = matchesService.getCustomerMatchData(matchUniqueId, baseRequest.authUserId);
        TblCricketMatch matchMiniDataOnly = matchesService.getMatchesRepository().getMatchMiniDataOnly(matchUniqueId);
    ...
    public BaseResponse getMatchPrivateContestDetail(String slug, BaseRequest baseRequest, int matchUniqueId) {
        ...
        for (HashMap<String, Object> hashMap : matchContest) {
            ...
            TblCricketMatch matchDataOnly = matchesService.getMatchesRepository().getMatchData(matchUniqueIdd);
    ...
    public BaseResponse getContestTeams(int UserId, int matchUniqueId, int matchContestId, int pageNo) {
        TblCricketMatch matchDataOnly = matchesService.getMatchesRepository().getMatchMiniDataOnly(matchUniqueId);
...
//                matchContestId);
    ...
    public BaseResponse customerJoinContestMulti(BaseRequest baseRequest) {
        ...
        for (HashMap<String, Object> teamData : matchCustomerTeamCount) {
            ...
            TblCricketCustomerContest customerJoinContest = contestRepository.customerJoinContest(matchDataOnly,
...
//                contestRepository.incrementContestTeamCount(matchContestId);
    ...
    public BaseResponse createPrivateContest(BaseRequest baseRequest) {
        ...
        TblCricketContestMatch createPrivateContest = contestRepository.createPrivateContest(matchDataOnly,
