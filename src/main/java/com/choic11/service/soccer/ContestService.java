...
import com.choic11.model.soccer.TblSoccerContestMatch;
import com.choic11.model.soccer.TblSoccerCustomerContest;
import com.choic11.model.soccer.TblSoccerMatch;
import com.choic11.repository.soccer.ContestRepository;
...
public class ContestService {
    ...
    public BaseResponse getMatchContest(BaseRequest baseRequest, int matchId, int matchUniqueId) {
        ...
        TblSoccerMatch matchMiniDataOnly = matchesService.getMatchesRepository().getMatchMiniDataOnly(matchUniqueId);
    ...
    public BaseResponse getCustomerMatchContest(BaseRequest baseRequest, int matchId, int matchUniqueId) {
        ...
        TblSoccerMatch matchData = matchesService.getCustomerMatchData(matchUniqueId, baseRequest.authUserId);
        TblSoccerMatch matchMiniDataOnly = matchesService.getMatchesRepository().getMatchMiniDataOnly(matchUniqueId);
    ...
    public BaseResponse getMatchPrivateContestDetail(String slug, BaseRequest baseRequest, int matchUniqueId) {
        ...
        for (HashMap<String, Object> hashMap : matchContest) {
            ...
            TblSoccerMatch matchDataOnly = matchesService.getMatchesRepository().getMatchData(matchUniqueIdd);
    ...
    public BaseResponse getContestTeams(int UserId, int matchUniqueId, int matchContestId, int pageNo) {
        TblSoccerMatch matchDataOnly = matchesService.getMatchesRepository().getMatchMiniDataOnly(matchUniqueId);
...
//                matchContestId);
    ...
    public BaseResponse customerJoinContestMulti(BaseRequest baseRequest) {
        ...
        for (HashMap<String, Object> teamData : matchCustomerTeamCount) {
            ...
            TblSoccerCustomerContest customerJoinContest = contestRepository.customerJoinContest(matchDataOnly,
...
//                contestRepository.incrementContestTeamCount(matchContestId);
    ...
    public BaseResponse createPrivateContest(BaseRequest baseRequest) {
        ...
        TblSoccerContestMatch createPrivateContest = contestRepository.createPrivateContest(matchDataOnly,
