 ...
 */
@Entity
@Table(name="tbl_basketball_customer_affiliates")
@NamedQuery(name="TblBasketballCustomerAffiliate.findAll", query="SELECT t FROM TblBasketballCustomerAffiliate t")
public class TblBasketballCustomerAffiliate implements Serializable {
	...
	public TblBasketballCustomerAffiliate() {
	}
