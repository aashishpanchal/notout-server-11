...
/**
 * The persistent class for the tbl_basketball_affiliates_contest database table.
 * 
 */
@Entity
@Table(name="tbl_basketball_customer_affiliates_contest")
@NamedQuery(name="TblBasketballCustomerAffiliatesContest.findAll", query="SELECT t FROM TblBasketballCustomerAffiliatesContest t")
public class TblBasketballCustomerAffiliatesContest implements Serializable {
	...
	public TblBasketballCustomerAffiliatesContest() {
	}
