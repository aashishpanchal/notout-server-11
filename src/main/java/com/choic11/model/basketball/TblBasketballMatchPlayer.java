...
/**
 * The persistent class for the tbl_basketball_match_players database table.
 * 
 */
@Entity
@Table(name = "tbl_basketball_match_players")
@NamedQuery(name = "TblBasketballMatchPlayer.findAll", query = "SELECT t FROM TblBasketballMatchPlayer t")
public class TblBasketballMatchPlayer implements Serializable {
	...
	TblBasketballPlayer tblBasketballPlayer;

	public TblBasketballMatchPlayer() {
	}
	...
	public TblBasketballPlayer getTblBasketballPlayer() {
		return tblBasketballPlayer;
	}

	public void setTblBasketballPlayer(TblBasketballPlayer tblBasketballPlayer) {
		this.tblBasketballPlayer = tblBasketballPlayer;
	}
