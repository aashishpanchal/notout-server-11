...
/**
 * The persistent class for the tbl_basketball_players database table.
 * 
 */
@Entity
@Table(name = "tbl_basketball_players")
@NamedQuery(name = "TblBasketballPlayer.findAll", query = "SELECT t FROM TblBasketballPlayer t")
public class TblBasketballPlayer implements Serializable {
