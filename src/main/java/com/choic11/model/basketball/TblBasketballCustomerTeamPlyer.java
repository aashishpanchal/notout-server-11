...
/**
 * The persistent class for the tbl_basketball_customer_team_plyers database table.
 * 
 */
@Entity
@Table(name="tbl_basketball_customer_team_plyers")
@NamedQuery(name="TblBasketballCustomerTeamPlyer.findAll", query="SELECT t FROM TblBasketballCustomerTeamPlyer t")
public class TblBasketballCustomerTeamPlyer implements Serializable {
	...
	public TblBasketballCustomerTeamPlyer() {
	}
