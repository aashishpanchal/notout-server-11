...
/**
 * The persistent class for the tbl_basketball_matches_scorecard database table.
 * 
 */
@Entity
@Table(name = "tbl_basketball_matches_scorecard")
@NamedQuery(name = "TblBasketballMatchesScorecard.findAll", query = "SELECT t FROM TblBasketballMatchesScorecard t")
public class TblBasketballMatchesScorecard implements Serializable {
	...
	public TblBasketballMatchesScorecard() {
	}
