 ...
 */
@Entity
@Table(name="tbl_basketball_affiliates_contest")
@NamedQuery(name="TblBasketballAffiliatesContest.findAll", query="SELECT t FROM TblBasketballAffiliatesContest t")
public class TblBasketballAffiliatesContest implements Serializable {
	...
	public TblBasketballAffiliatesContest() {
	}
