 ...
 */
@Entity
@Table(name="tbl_basketball_affiliates")
@NamedQuery(name="TblBasketballAffiliate.findAll", query="SELECT t FROM TblBasketballAffiliate t")
public class TblBasketballAffiliate implements Serializable {
