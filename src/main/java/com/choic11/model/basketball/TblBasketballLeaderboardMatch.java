...
/**
 * The persistent class for the tbl_basketball_leaderboard_matches database table.
 * 
 */
@Entity
@Table(name="tbl_basketball_leaderboard_matches")
@NamedQuery(name="TblBasketballLeaderboardMatch.findAll", query="SELECT t FROM TblBasketballLeaderboardMatch t")
public class TblBasketballLeaderboardMatch implements Serializable {
	...
	public TblBasketballLeaderboardMatch() {
	}
