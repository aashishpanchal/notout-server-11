...
/**
 * The persistent class for the tbl_basketball_series database table.
 * 
 */
@Entity
@Table(name="tbl_basketball_series")
@NamedQuery(name="TblBasketballSeries.findAll", query="SELECT t FROM TblBasketballSeries t")
public class TblBasketballSeries implements Serializable {
