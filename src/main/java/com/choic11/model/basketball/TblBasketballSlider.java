...
/**
 * The persistent class for the tbl_basketball_sliders database table.
 * 
 */
@Entity
@Table(name="tbl_basketball_sliders")
@NamedQuery(name="TblBasketballSlider.findAll", query="SELECT t FROM TblBasketballSlider t")
public class TblBasketballSlider implements Serializable {
	...
	private TblBasketballMatch tblBasketballMatch;
	...
	public void setTblBasketballMatch(TblBasketballMatch tblBasketballMatch) {
		this.tblBasketballMatch = tblBasketballMatch;
	}
	
	public TblBasketballMatch getTblBasketballMatch() {
