 ...
 */
@Entity
@Table(name="tbl_soccer_customer_affiliates_contest")
@NamedQuery(name="TblSoccerCustomerAffiliatesContest.findAll", query="SELECT t FROM TblSoccerCustomerAffiliatesContest t")
public class TblSoccerCustomerAffiliatesContest implements Serializable {
	...
	public TblSoccerCustomerAffiliatesContest() {
	}
