...
/**
 * The persistent class for the tbl_soccer_contest_categories database table.
 * 
 */
@Entity
@Table(name="tbl_soccer_contest_categories")
@NamedQuery(name="TblSoccerContestCategory.findAll", query="SELECT t FROM TblSoccerContestCategory t")
public class TblSoccerContestCategory implements Serializable {
	...
	public TblSoccerContestCategory() {
	}
