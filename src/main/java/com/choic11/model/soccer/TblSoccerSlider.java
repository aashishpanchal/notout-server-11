...
/**
 * The persistent class for the tbl_soccer_sliders database table.
 * 
 */
@Entity
@Table(name="tbl_soccer_sliders")
@NamedQuery(name="TblSoccerSlider.findAll", query="SELECT t FROM TblSoccerSlider t")
public class TblSoccerSlider implements Serializable {
	...
	private TblSoccerMatch tblSoccerMatch;
	...
	public void setTblSoccerMatch(TblSoccerMatch tblSoccerMatch) {
		this.tblSoccerMatch = tblSoccerMatch;
	}
	
	public TblSoccerMatch getTblSoccerMatch() {
