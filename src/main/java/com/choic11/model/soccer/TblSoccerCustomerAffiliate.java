 ...
 */
@Entity
@Table(name="tbl_soccer_customer_affiliates")
@NamedQuery(name="TblSoccerCustomerAffiliate.findAll", query="SELECT t FROM TblSoccerCustomerAffiliate t")
public class TblSoccerCustomerAffiliate implements Serializable {
	...
	public TblSoccerCustomerAffiliate() {
	}
