...
/**
 * The persistent class for the tbl_soccer_match_players database table.
 * 
 */
@Entity
@Table(name = "tbl_soccer_match_players")
@NamedQuery(name = "TblSoccerMatchPlayer.findAll", query = "SELECT t FROM TblSoccerMatchPlayer t")
public class TblSoccerMatchPlayer implements Serializable {
    ...
    TblSoccerPlayer tblSoccerPlayer;

	public TblSoccerMatchPlayer() {
	}
	...
	public TblSoccerPlayer getTblSoccerPlayer() {
		return tblSoccerPlayer;
	}

	public void setTblSoccerPlayer(TblSoccerPlayer tblSoccerPlayer) {
		this.tblSoccerPlayer = tblSoccerPlayer;
	}
