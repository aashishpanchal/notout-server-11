...
/**
 * The persistent class for the tbl_soccer_contest_matches database table.
 * 
 */
@Entity
@Table(name = "tbl_soccer_contest_matches")
@NamedQuery(name = "TblSoccerContestMatch.findAll", query = "SELECT t FROM TblSoccerContestMatch t")
public class TblSoccerContestMatch implements Serializable {
	...
	public static TblSoccerContestMatch getInstance() {
		TblSoccerContestMatch tblSoccerContestMatch = new TblSoccerContestMatch();
		tblSoccerContestMatch.contestId = 0;
		tblSoccerContestMatch.actualEntryFees = 0;
		tblSoccerContestMatch.moreEntryFees = 0;
		tblSoccerContestMatch.maxEntryFees = 0;
		tblSoccerContestMatch.userId = 0;
		tblSoccerContestMatch.teamId = 0;
		tblSoccerContestMatch.entryFeeMultiplier = 0;
		tblSoccerContestMatch.duplicateCount = 0;
		tblSoccerContestMatch.parentId = 0;
		tblSoccerContestMatch.createdAt = BigInteger.valueOf(0);
		tblSoccerContestMatch.createdBy = 0;
		tblSoccerContestMatch.updatedAt = BigInteger.valueOf(0);
		tblSoccerContestMatch.updatedBy = 0;
		tblSoccerContestMatch.totalJoinedTeam = 0;
		tblSoccerContestMatch.duplicateCreatedCount = 0;
		tblSoccerContestMatch.confirmWin = "N";
		tblSoccerContestMatch.isCompressionAllow = "N";
		tblSoccerContestMatch.multiTeamAllowed = "N";
		tblSoccerContestMatch.pdfProcess = "N";
		tblSoccerContestMatch.status = "A";
		tblSoccerContestMatch.isPrivate = "N";
		tblSoccerContestMatch.isBeatTheExpert = "N";
		tblSoccerContestMatch.isDuplicateAllow = "N";
		tblSoccerContestMatch.isDuplicatedCreated = "N";
		tblSoccerContestMatch.isDeleted = "N";
		tblSoccerContestMatch.isAbondant = "N";
		tblSoccerContestMatch.isResult = "N";
		tblSoccerContestMatch.isAffiliateEarnAllow = "Y";
		tblSoccerContestMatch.confirmWinContestPercentage = 60;
		tblSoccerContestMatch.oldTotalPrice = -1;
		tblSoccerContestMatch.cashBonusUsedType = "F";
		tblSoccerContestMatch.cashBonusUsedValue = 0;
		tblSoccerContestMatch.isLeaderBoardAvaliable = "N";
