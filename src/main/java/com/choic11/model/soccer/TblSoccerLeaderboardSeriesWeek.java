...
/**
 * The persistent class for the tbl_soccer_leaderboard_series_week database table.
 * 
 */
@Entity
@Table(name="tbl_soccer_leaderboard_series_week")
@NamedQuery(name="TblSoccerLeaderboardSeriesWeek.findAll", query="SELECT t FROM TblSoccerLeaderboardSeriesWeek t")
public class TblSoccerLeaderboardSeriesWeek implements Serializable {
	...
	public TblSoccerLeaderboardSeriesWeek() {
	}
