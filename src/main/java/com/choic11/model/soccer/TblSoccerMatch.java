...
/**
 * The persistent class for the tbl_soccer_matches database table.
 * 
 */
@Entity
@Table(name = "tbl_soccer_matches")
@NamedQuery(name = "TblSoccerMatch.findAll", query = "SELECT t FROM TblSoccerMatch t")
public class TblSoccerMatch implements Serializable {
	...
	public TblSoccerSeries getTblSoccerSery() {
		return this.tblSoccerSery;
	}

	public void setTblSoccerSery(TblSoccerSeries tblSoccerSery) {
		this.tblSoccerSery = tblSoccerSery;
	}

	public TblSoccerTeam getTblSoccerTeam() {
		return this.tblSoccerTeam;
	}

	public void setTblSoccerTeam(TblSoccerTeam tblSoccerTeam) {
		this.tblSoccerTeam = tblSoccerTeam;
	}

	public TblSoccerTeam getTblSoccerTeam2() {
		return tblSoccerTeam2;
	}

	public void setTblSoccerTeam2(TblSoccerTeam tblSoccerTeam2) {
		this.tblSoccerTeam2 = tblSoccerTeam2;
	}

	public TblSoccerGameType getTblGameType() {
		return this.tblGameType;
	}

	public void setTblGameType(TblSoccerGameType tblGameType) {
