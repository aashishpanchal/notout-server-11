...
/**
 * The persistent class for the tbl_soccer_leaderboard_series database table.
 * 
 */
@Entity
@Table(name="tbl_soccer_leaderboard_series")
@NamedQuery(name="TblSoccerLeaderboardSeries.findAll", query="SELECT t FROM TblSoccerLeaderboardSeries t")
public class TblSoccerLeaderboardSeries implements Serializable {
	...
	public TblSoccerLeaderboardSeries() {
	}
