...
/**
 * The persistent class for the tbl_soccer_matches_scorecard database table.
 * 
 */
@Entity
@Table(name = "tbl_soccer_matches_scorecard")
@NamedQuery(name = "TblSoccerMatchesScorecard.findAll", query = "SELECT t FROM TblSoccerMatchesScorecard t")
public class TblSoccerMatchesScorecard implements Serializable {
	...
	public TblSoccerMatchesScorecard() {
	}
