...
/**
 * The persistent class for the tbl_soccer_matches_lineup database table.
 * 
 */
@Entity
@Table(name="tbl_soccer_matches_lineup")
@NamedQuery(name="TblSoccerMatchesLineup.findAll", query="SELECT t FROM TblSoccerMatchesLineup t")
public class TblSoccerMatchesLineup implements Serializable {
