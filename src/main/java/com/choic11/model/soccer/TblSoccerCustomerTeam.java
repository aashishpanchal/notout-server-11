 ...
 */
@Entity
@Table(name="tbl_soccer_customer_teams")
@NamedQuery(name="TblSoccerCustomerTeam.findAll", query="SELECT t FROM TblSoccerCustomerTeam t")
public class TblSoccerCustomerTeam implements Serializable {
