 ...
 */
@Entity
@Table(name="tbl_soccer_customer_match_info")
@NamedQuery(name="TblSoccerCustomerMatchInfo.findAll", query="SELECT t FROM TblSoccerCustomerMatchInfo t")
public class TblSoccerCustomerMatchInfo implements Serializable {
