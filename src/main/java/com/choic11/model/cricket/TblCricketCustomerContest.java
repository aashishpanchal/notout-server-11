 ...
 */
@Entity
@Table(name = "tbl_cricket_customer_contests")
@NamedQuery(name = "TblCricketCustomerContest.findAll", query = "SELECT t FROM TblCricketCustomerContest t")
public class TblCricketCustomerContest implements Serializable {
	...
	public TblCricketCustomerContest() {
	}
	...
	public static TblCricketCustomerContest getInstance() {
		TblCricketCustomerContest tblCricketCustomerContest = new TblCricketCustomerContest();

		tblCricketCustomerContest.customerId = 0;
		tblCricketCustomerContest.matchUniqueId = 0;
		tblCricketCustomerContest.matchContestId = 0;
		tblCricketCustomerContest.customerTeamId = 0;
		tblCricketCustomerContest.entryFees = 0;
		tblCricketCustomerContest.oldRank = 0;
		tblCricketCustomerContest.newRank = 0;
		tblCricketCustomerContest.oldPoints = 0;
		tblCricketCustomerContest.newPoints = 0;
		tblCricketCustomerContest.winAmount = 0;
		tblCricketCustomerContest.winGadget = "";
		tblCricketCustomerContest.refundAmount = 0;
		tblCricketCustomerContest.taxAmount = 0;
		tblCricketCustomerContest.taxPercent = 0;
		tblCricketCustomerContest.created = BigInteger.valueOf(0);
		tblCricketCustomerContest.updated = BigInteger.valueOf(0);
		tblCricketCustomerContest.cashBonusWallet = 0;
		tblCricketCustomerContest.depositeWallet = 0;
		tblCricketCustomerContest.winningWallet = 0;
		tblCricketCustomerContest.givenByUserAmount = 0;
		tblCricketCustomerContest.givenByAdminAmount = 0;
		tblCricketCustomerContest.isAbondant = "N";
