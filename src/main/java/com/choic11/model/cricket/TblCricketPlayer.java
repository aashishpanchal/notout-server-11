...
/**
 * The persistent class for the tbl_cricket_players database table.
 * 
 */
@Entity
@Table(name = "tbl_cricket_players")
@NamedQuery(name = "TblCricketPlayer.findAll", query = "SELECT t FROM TblCricketPlayer t")
public class TblCricketPlayer implements Serializable {
