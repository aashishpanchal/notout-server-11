...
/**
 * The persistent class for the tbl_cricket_contest_categories database table.
 * 
 */
@Entity
@Table(name="tbl_cricket_contest_categories")
@NamedQuery(name="TblCricketContestCategory.findAll", query="SELECT t FROM TblCricketContestCategory t")
public class TblCricketContestCategory implements Serializable {
	...
	public TblCricketContestCategory() {
	}
