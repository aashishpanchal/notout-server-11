...
/**
 * The persistent class for the tbl_cricket_affiliates_contest database table.
 * 
 */
@Entity
@Table(name="tbl_cricket_customer_affiliates_contest")
@NamedQuery(name="TblCricketCustomerAffiliatesContest.findAll", query="SELECT t FROM TblCricketCustomerAffiliatesContest t")
public class TblCricketCustomerAffiliatesContest implements Serializable {
	...
	public TblCricketCustomerAffiliatesContest() {
	}
