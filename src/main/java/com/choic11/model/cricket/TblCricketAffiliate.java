 ...
 */
@Entity
@Table(name="tbl_cricket_affiliates")
@NamedQuery(name="TblCricketAffiliate.findAll", query="SELECT t FROM TblCricketAffiliate t")
public class TblCricketAffiliate implements Serializable {
