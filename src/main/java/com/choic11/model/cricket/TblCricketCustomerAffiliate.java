...
/**
 * The persistent class for the tbl_cricket_affiliates database table.
 * 
 */
@Entity
@Table(name="tbl_cricket_customer_affiliates")
@NamedQuery(name="TblCricketCustomerAffiliate.findAll", query="SELECT t FROM TblCricketCustomerAffiliate t")
public class TblCricketCustomerAffiliate implements Serializable {
	...
	public TblCricketCustomerAffiliate() {
	}
