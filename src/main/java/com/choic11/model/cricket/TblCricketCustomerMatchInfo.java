 ...
 */
@Entity
@Table(name="tbl_cricket_customer_match_info")
@NamedQuery(name="TblCricketCustomerMatchInfo.findAll", query="SELECT t FROM TblCricketCustomerMatchInfo t")
public class TblCricketCustomerMatchInfo implements Serializable {
