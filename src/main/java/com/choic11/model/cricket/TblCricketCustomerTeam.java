...
/**
 * The persistent class for the tbl_cricket_customer_teams database table.
 * 
 */
@Entity
@Table(name="tbl_cricket_customer_teams")
@NamedQuery(name="TblCricketCustomerTeam.findAll", query="SELECT t FROM TblCricketCustomerTeam t")
public class TblCricketCustomerTeam implements Serializable {
