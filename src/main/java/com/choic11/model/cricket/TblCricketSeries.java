...
/**
 * The persistent class for the tbl_cricket_series database table.
 * 
 */
@Entity
@Table(name="tbl_cricket_series")
@NamedQuery(name="TblCricketSery.findAll", query="SELECT t FROM TblCricketSeries t")
public class TblCricketSeries implements Serializable {
