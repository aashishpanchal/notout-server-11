...
/**
 * The persistent class for the tbl_cricket_matches database table.
 * 
 */
@Entity
@Table(name = "tbl_cricket_matches")
@NamedQuery(name = "TblCricketMatch.findAll", query = "SELECT t FROM TblCricketMatch t")
public class TblCricketMatch implements Serializable {
	...
	public TblCricketSeries getTblCricketSery() {
		return this.tblCricketSery;
	}

	public void setTblCricketSery(TblCricketSeries tblCricketSery) {
		this.tblCricketSery = tblCricketSery;
	}

	public TblCricketTeam getTblCricketTeam() {
		return this.tblCricketTeam;
	}

	public void setTblCricketTeam(TblCricketTeam tblCricketTeam) {
		this.tblCricketTeam = tblCricketTeam;
	}

	public TblCricketTeam getTblCricketTeam2() {
		return tblCricketTeam2;
	}

	public void setTblCricketTeam2(TblCricketTeam tblCricketTeam2) {
		this.tblCricketTeam2 = tblCricketTeam2;
	}

	public TblCricketGameType getTblGameType() {
		return this.tblGameType;
	}

	public void setTblGameType(TblCricketGameType tblGameType) {
