...
/**
 * The persistent class for the tbl_cricket_leaderboard_matches database table.
 * 
 */
@Entity
@Table(name="tbl_cricket_leaderboard_matches")
@NamedQuery(name="TblCricketLeaderboardMatch.findAll", query="SELECT t FROM TblCricketLeaderboardMatch t")
public class TblCricketLeaderboardMatch implements Serializable {
	...
	public TblCricketLeaderboardMatch() {
	}
