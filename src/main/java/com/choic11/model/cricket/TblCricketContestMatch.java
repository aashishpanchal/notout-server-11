...
/**
 * The persistent class for the tbl_cricket_contest_matches database table.
 * 
 */
@Entity
@Table(name = "tbl_cricket_contest_matches")
@NamedQuery(name = "TblCricketContestMatch.findAll", query = "SELECT t FROM TblCricketContestMatch t")
public class TblCricketContestMatch implements Serializable {
	...
	public static TblCricketContestMatch getInstance() {
		TblCricketContestMatch tblCricketContestMatch = new TblCricketContestMatch();
		tblCricketContestMatch.contestId = 0;
		tblCricketContestMatch.actualEntryFees = 0;
		tblCricketContestMatch.moreEntryFees = 0;
		tblCricketContestMatch.maxEntryFees = 0;
		tblCricketContestMatch.userId = 0;
		tblCricketContestMatch.teamId = 0;
		tblCricketContestMatch.entryFeeMultiplier = 0;
		tblCricketContestMatch.duplicateCount = 0;
		tblCricketContestMatch.parentId = 0;
		tblCricketContestMatch.createdAt = BigInteger.valueOf(0);
		tblCricketContestMatch.createdBy = 0;
		tblCricketContestMatch.updatedAt = BigInteger.valueOf(0);
		tblCricketContestMatch.updatedBy = 0;
		tblCricketContestMatch.totalJoinedTeam = 0;
		tblCricketContestMatch.duplicateCreatedCount = 0;
		tblCricketContestMatch.confirmWin = "N";
		tblCricketContestMatch.isCompressionAllow = "N";
		tblCricketContestMatch.multiTeamAllowed = "N";
		tblCricketContestMatch.pdfProcess = "N";
		tblCricketContestMatch.status = "A";
		tblCricketContestMatch.isPrivate = "N";
		tblCricketContestMatch.isBeatTheExpert = "N";
		tblCricketContestMatch.isDuplicateAllow = "N";
		tblCricketContestMatch.isDuplicatedCreated = "N";
		tblCricketContestMatch.isDeleted = "N";
		tblCricketContestMatch.isAbondant = "N";
		tblCricketContestMatch.isResult = "N";
		tblCricketContestMatch.isAffiliateEarnAllow = "Y";
		tblCricketContestMatch.confirmWinContestPercentage = 60;
		tblCricketContestMatch.oldTotalPrice = -1;
		tblCricketContestMatch.cashBonusUsedType = "F";
		tblCricketContestMatch.cashBonusUsedValue = 0;
		tblCricketContestMatch.isLeaderBoardAvaliable = "N";
