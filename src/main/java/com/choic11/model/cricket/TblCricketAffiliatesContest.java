 ...
 */
@Entity
@Table(name="tbl_cricket_affiliates_contest")
@NamedQuery(name="TblCricketAffiliatesContest.findAll", query="SELECT t FROM TblCricketAffiliatesContest t")
public class TblCricketAffiliatesContest implements Serializable {
	...
	public TblCricketAffiliatesContest() {
	}
