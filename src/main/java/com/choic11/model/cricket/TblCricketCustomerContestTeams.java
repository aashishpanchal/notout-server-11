...
/**
 * The persistent class for the tbl_cricket_customer_contest_teams database table.
 * 
 */
@Entity
@Table(name="tbl_cricket_customer_contest_teams")
@NamedQuery(name="TblCricketCustomerContestTeams.findAll", query="SELECT t FROM TblCricketCustomerContestTeams t")
public class TblCricketCustomerContestTeams implements Serializable {
	...
	public TblCricketCustomerContestTeams() {
	}
